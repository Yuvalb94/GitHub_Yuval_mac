...
if __name__ == "__main__":
    ...
    path_to_light_data = r'/Users/cohenlab/Desktop/light_monitor_project/light_data/test2_11-30_01'
    # light_data = pd.read_csv(fr"{path_to_light_data}/03_01_24.csv", index_col=0)
    light_data = accumulate_data(path_to_light_data, write=True)
    ...
    light_status['light_on'][7] += datetime.timedelta(minutes=55)
    ...
    plt.text(dates[4], 14.9, f"{days_shift} days forward shift", c='k', va='top', ha='right', fontsize = 'large')
